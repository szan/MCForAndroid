 ...
 * Time: 15:22
 */
public class MCBitDeviceItem extends MCDeviceItem {
    public MCBitDeviceItem(Context context, MCDeviceCode deviceCode, int deviceNumber, String deviceName) throws IndexOutOfBoundsException {
